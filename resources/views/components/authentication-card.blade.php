...
<style> 
    ...
    .content-container {
        ...
        border: 2px solid #e2e8f0; /* Bordes sutiles para destacar el contenedor */
    }
    ...
    @media (prefers-color-scheme: dark) {
        ...
        .content-container {
            background-color: #212529; /* Fondo oscuro para el contenido */
            color: #ffffff; /* Texto blanco en modo oscuro */
            border-color: #444444; /* Bordes de color más oscuro en modo oscuro */
            box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3); /* Sombra más pronunciada en modo oscuro */
        }
    }
</style>
